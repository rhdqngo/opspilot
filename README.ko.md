...
| 한국어 기술 문서·원본 기획서 묶음 | [ZIP 압축 파일](opspilot-korean-docs.zip) |
...
| 보안 | [취약점 제보 정책](SECURITY.ko.md), [위협 모델](docs/security/threat-model.ko.md), [IAM 매트릭스](docs/iam-matrix.ko.md) |
